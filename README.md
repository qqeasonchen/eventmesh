...
- **LLM streaming agent runtime** — a standalone [agent process](docs/feature/agent-tools.md) hosts OpenAI-compatible LLM streaming sessions on the mesh, with function-calling tools: any [connector](docs/feature/connectors/README.md) becomes an agent tool, custom tools ship as [agent plugins](eventmesh-agent-plugin/) (SPI), and topics can drive agents as event triggers with decisions published back for sink delivery.
...
- User guides — [Java client](docs/feature/client-java.md) · [pub/sub](docs/feature/pubsub.md) · [delivery reliability](docs/feature/delivery-reliability.md) · [streaming](docs/feature/streaming.md) · [lite topic](docs/feature/lite-topic.md) · [A2A](docs/feature/a2a.md) · [agent tools](docs/feature/agent-tools.md)
