...
# 查看连接统计
curl -s http://localhost:10106/actuator/native-protocol/stats | jq
```
...
### Q: 如何优化性能？
A: 启用协议透传优化：`eventmesh.native.transmission.optimization.enabled=true`
...
- 📖 阅读 [完整使用指南](native-protocol-support.md)
- 🔧 查看 [配置参考](native-protocol-config.md)
- 🚀 了解 [性能优化](native-protocol-performance.md)
- 🛡️ 学习 [安全配置](native-protocol-security.md) 