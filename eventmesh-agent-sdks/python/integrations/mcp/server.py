"""EventMesh Agent MCP Bridge — connect any MCP client to EventMesh A2A Agent Mesh.

Exposes EventMesh A2A agents as MCP tools for Claude Code, Cursor, and other
...
logger = logging.getLogger("eventmesh-agent-mcp")
