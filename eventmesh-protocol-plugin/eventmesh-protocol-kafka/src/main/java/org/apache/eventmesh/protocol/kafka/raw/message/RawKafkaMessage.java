...
package org.apache.eventmesh.protocol.kafka.raw.message;
...
/**
 * Raw Kafka message wrapper implementing ProtocolTransportObject.
 * Contains complete Kafka message metadata including partition, offset, timestamp, etc.
 */
@Data
public class RawKafkaMessage implements ProtocolTransportObject {
