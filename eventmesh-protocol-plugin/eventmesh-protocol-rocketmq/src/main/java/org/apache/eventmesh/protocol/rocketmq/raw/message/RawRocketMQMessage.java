...
package org.apache.eventmesh.protocol.rocketmq.raw.message;
...
/**
 * Raw RocketMQ message wrapper implementing ProtocolTransportObject.
 * Contains complete RocketMQ message metadata including queueId, queueOffset, properties, etc.
 */
@Data
public class RawRocketMQMessage implements ProtocolTransportObject {
    ...
    /**
     * Check if this message has been consumed before
     */
    public boolean isReconsumed() {
        return reconsumeTimes != null && reconsumeTimes > 0;
    }
